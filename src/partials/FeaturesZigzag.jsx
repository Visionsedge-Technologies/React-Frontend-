      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <div className="inline-flex text-sm font-semibold py-1 px-3 m-2 text-green-600 bg-green-200 rounded-full mb-4">Reach goals that matter with</div>
            <h1 className="h2 mb-4">Devops unlimited solutions</h1>
            <p className="text-xl text-gray-400">VisionsEdge Technologies is an IT service distributor which is recognized as a technology expert. Our company offers services in web/mobile app development, CMS & software product engineering.</p>
          </div>
