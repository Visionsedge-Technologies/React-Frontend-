      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-10 pb-12 md:pt-16 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4" data-aos="fade-up">Successfully delivered multiple DevOps solutions and services</h2>
            <p className="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200">
            Our service carter to a robust systems that provides results in real-time, faster, and efficiently optimizes all IT operations</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">1</span>. Process Automation</h4>
              <p className="text-lg text-gray-400 text-center">We provide the most emerging process automation for operation and best performance. We automate and streamline the entire pipeline process from production to code generation, quality check, unifold builds, and many more</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">2</span>. Support Monitoring</h4>
              <p className="text-lg text-gray-400 text-center">VisionsEdge Technologies solves the issue before the problem occurs and maintains 100% systems performance with Zero Down Time. We provide the tools to supports, monitor and reslove issues instanteneouly.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400">
              ...
              <h4 className="h4 mb-2"><span className="text-gray-400">3</span>. Cloud Management</h4>
              <p className="text-lg text-gray-400 text-center">We offer excellent cloud management services to migrate to the cloud over multiple cloud platforms to build faster and higly available applications that is necessary for long-term business success.</p>
            </div>
