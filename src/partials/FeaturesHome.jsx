            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right" data-aos-anchor="[data-aos-id-features-home]">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <div className="font-architects-daughter text-xl text-indigo-600 mb-2">Go head to head with industry leaders </div>
                  <h3 className="h3 mb-3">Lighting fast workflow</h3>
                  <p className="text-xl text-gray-400 mb-4">Adopting DevOps has helped us reduce our system's development life cycle while providing perpetual delivery with high-quality software. </p>
                  <ul className="flex flex-wrap text-lg text-gray-400 -mx-2 -my-1">
                    <li className="flex items-center mx-2 my-1">
                      ...
                      <span>Faster collaboration</span>
                    </li>
                    <li className="flex items-center mx-2 my-1">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
                    ...
                    <li className="flex items-center mx-2 my-1">
                      ...
                      <span>Reliable Environment</span>
                    </li>
                  </ul>
...
VisionsEdge Technology's DevOps model has reduced the overall workload of the organization and provided quality assurance and development teams that ensures our software runs with the organization structure and production cycle.".</blockquote>
                      <div className="text-gray-700 font-medium">
                        <cite className="text-gray-200 not-italic">— Anastasia Dan</cite> - <a className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out" href="#0">Snr Eng. @Brysworth</a>
                      </div>
                    </div>
                  </div>
                </div>
